...
namespace Rife.Api.Migrations
{
    ...
    [Migration("20210702113458_TasksTableMigrationOrder")]
    partial class TasksTableMigrationOrder
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rife.Api.Models.Clients", b =>
                {
                    b.Property<string>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Rife.Api.Models.MyTask", b =>
                {
                    b.Property<string>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Rife.Api.Models.User", b =>
                {
            ...
            modelBuilder.Entity("Rife.Api.Models.Clients", b =>
                {
                    b.HasOne("Rife.Api.Models.User", null)
                        .WithMany("MyUsers")
                        .HasForeignKey("UserId");
                });
